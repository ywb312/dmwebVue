    ...
    <div>
        ...
        <Popup :popshow="popshow" @close="popshow=false">
            ...
            <div slot="views" class="popup">
                ...
                <div>
                    <p>建筑防火等级: {{selectData.level}}</p>
                </div>
                <div>
                    <p>消防设施情况: {{selectData.xfseflag}}</p>
                </div>
                <div>
                    <p>验收情况: {{selectData.ysflag}}</p>
                </div>
                <div>
                    <p>管理部门: {{selectData.mangedept}}</p>
                </div>
                <div>
...
export default {
    name: "StaffDensePlace",
    data() {
        return {
            // 渲染的数据
            rendering: [],
            postData: {
                url: "biz/operate/staffdenseplace/list.action",
                obj: {}
            },
            show: false,
            popshow: false,
